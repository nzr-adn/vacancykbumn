...
(function($){
    ...
    jQuery.fn.sheepIt = function (options){
        ...
        function clickOnAddN(event)
        {
            event.preventDefault();
            if (addNInput.value !== '') {
                addNForms(addNInput.prop('value'));
            }
        }
...
/*
                    ...
                    if ( typeof(form.data('nestedForms')) != 'undefined') {
                        if (form.data('nestedForms').length > 0) {
                            ...
                            for (x in form.data('nestedForms')) {
                                ...
                                if (index == form.data('nestedForms')[x].prop('id') && typeof(value) == 'object') {
        ...
        var add,
            ...
            defaults = {
                ...
                // Controls selectors
                addSelector: '#' + $(this).prop("id") + '_add',
                addNSelector: '#' + $(this).prop("id") + '_add_n',
                addNInputSelector: '#' + $(this).prop("id") + '_add_n_input',
                addNButtonSelector: '#' + $(this).prop("id") + '_add_n_button',
                removeLastSelector: '#' + $(this).prop("id") + '_remove_last',
                removeCurrentSelector: '#' + $(this).prop("id") + '_remove_current',
                removeAllSelector: '#' + $(this).prop("id") + '_remove_all',
                controlsSelector: '#' + $(this).prop("id") + '_controls',
                labelSelector: '#' + $(this).prop("id") + '_label',
                ...
                // Templates
                formTemplateSelector: '#' + $(this).prop("id") + '_template',
                noFormsTemplateSelector: '#' + $(this).prop("id") + '_noforms_template',
