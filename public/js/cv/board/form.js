...
function validasiNIK(){
  $('#nik, #nik_cv').keypress(function (e) {
        ...
        if (e.shiftKey || (e.keyCode < 48 || e.keyCode > 57)) {
          ...
          if(nik_array.length>0){
            if(nik_array[0]==0){
              ...
              e.preventDefault();
              $('#error_msg, #error_msg2').html(`NIK tidak boleh lebih dari 16 digit`);
            } else{
              $('#error_msg, #error_msg2').html('');
            }
          }
        }
      }
