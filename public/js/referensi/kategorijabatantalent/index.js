...
$(document).ready(function(){
	$('body').on('click','.cls-add',function(){
		winform(urlcreate, {}, 'Tambah Kategori Jabatan');
	});

	$('body').on('click','.cls-button-edit',function(){
		winform(urledit, {'id':$(this).data('id')}, 'Ubah Kategori Jabatan');
	});
...
function setDatatable(){
  ...
  .on('xhr.dt', function ( e, settings, json, xhr ) {
      ...
      columns: [
        ...
        { data: 'kategori_data_talent', name: 'kategori_data_talent', searchable: false},
...
function onbtndelete(element){
	swal.fire({
        title: "Pemberitahuan",
        text: "Yakin hapus Kategori Jabatan "+$(element).data('keterangan')+" ?",
        type: "warning",
