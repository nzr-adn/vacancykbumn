...
$(document).ready(function(){
	$('body').on('click','.cls-add',function(){
		winform(urlcreate, {}, 'Tambah Referensi Kualifikasi Personal');
	});

	$('body').on('click','.cls-button-edit',function(){
		winform(urledit, {'id':$(this).data('id')}, 'Ubah Referensi Kualifikasi Personal');
	});
...
function onbtndelete(element){
	swal.fire({
        title: "Pemberitahuan",
        text: "Yakin hapus data Kualifikasi "+$(element).data('nama')+" ?",
        type: "warning",
