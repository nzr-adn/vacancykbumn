...
$(document).ready(function(){
	$('body').on('click','.cls-add',function(){
		winform(urlcreate, {}, 'Tambah Keahlian');
	});

	$('body').on('click','.cls-button-edit',function(){
		winform(urledit, {'id':$(this).data('id')}, 'Ubah Keahlian');
	});
...
function setDatatable(){
  ...
  .on('xhr.dt', function ( e, settings, json, xhr ) {
      ...
      columns: [
        ...
        { data: 'jenis_keahlian', name: 'jenis_keahlian', searchable: true},
...
function onbtndelete(element){
	swal.fire({
        title: "Pemberitahuan",
        text: "Yakin hapus data Keahlian "+$(element).data('jenis_keahlian')+" ?",
        type: "warning",
