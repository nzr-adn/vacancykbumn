...
$(document).ready(function(){
	$('body').on('click','.cls-button-approve',function(){
		onbtnapprove(this);
	});
...
function setDatatable(){
  ...
  .on('xhr.dt', function ( e, settings, json, xhr ) {
      ...
      columns: [
        ...
        { data: 'negara', name: 'negara', searchable: true},
...
function onbtndelete(element){
	swal.fire({
        title: "Pemberitahuan",
        text: "Yakin hapus data Universitas "+$(element).data('nama')+" ?",
        type: "warning",
...
function onbtnapprove(element){
	swal.fire({
        title: "Pemberitahuan",
        text: "Approve data Universitas "+$(element).data('nama')+" ?",
        type: "warning",
        showCancelButton: true,
