...
$(document).ready(function () {
    $("body").on("click", ".cls-add", function () {
        winform(urlcreate, {}, "Tambah Standar Value");
    });

    $("body").on("click", ".cls-button-edit", function () {
        winform(urledit, { id: $(this).data("id") }, "Ubah Standar Value");
    });
    ...
    datatable = $("#datatable")
        ...
        .DataTable({
            ...
            columns: [
                ...
                { data: "opsi", name: "opsi", searchable: true },
...
function onbtndelete(element) {
    swal.fire({
        title: "Pemberitahuan",
        text:
            "Yakin hapus data Standar Value " +
            $(element).data("standarvalue") +
            " ?",
        type: "warning",
