...
$(document).ready(function () {
    $("body").on("click", ".cls-add", function () {
        winform(urlcreate, {}, "Tambah Operator");
    });

    $("body").on("click", ".cls-button-edit", function () {
        winform(urledit, { id: $(this).data("id") }, "Ubah Operator");
    });
    ...
    $("body").on("click", "#is_sorting", function () {
        onbtnIs_sorting(this);
    });
    ...
    datatable = $("#datatable")
        ...
        .DataTable({
            ...
            columns: [
                ...
                { data: "operator", name: "operator", searchable: true },
                {
                    data: "check",
                    name: "check",
                    orderable: false,
...
function onbtndelete(element) {
    swal.fire({
        title: "Pemberitahuan",
        text: "Yakin hapus data Operator " + $(element).data("operator") + " ?",
        type: "warning",
...
function onbtnIs_sorting(element) {
    swal.fire({
        title: "Pemberitahuan",
        text:
            $(element).data("original-title") +
        ...
        if (result.value) {
            $.ajax({
                ...
                data: {
                    id: $(element).data("id"),
                    is_sorting: $(element).data("is_sorting"),
                },
                type: "post",
                dataType: "json",
                beforeSend: function () {
