...
$(document).ready(function(){
	$('body').on('click','.cls-add',function(){
		winform(urlcreate, {}, 'Tambah Periode');
	});

	$('body').on('click','.cls-button-edit',function(){
		winform(urledit, {'id':$(this).data('id')}, 'Ubah Periode');
	});
...
function setDatatable(){
  ...
  .on('xhr.dt', function ( e, settings, json, xhr ) {
      ...
      columns: [
        ...
        { data: 'tmt_awal', name: 'tmt_awal', searchable: true},
        { data: 'tmt_akhir', name: 'tmt_akhir', searchable: true},
        { data: 'aktif', name: 'aktif', searchable: true},
...
function onbtndelete(element){
	swal.fire({
        title: "Pemberitahuan",
        text: "Yakin hapus data Periode "+$(element).data('periode')+" ?",
        type: "warning",
